  ...
  theme: {
    ...
    extend: {
      ...
      colors: {
        ...
        game: {
          hp: "hsl(var(--game-hp))",
          stamina: "hsl(var(--game-stamina))",
          xp: "hsl(var(--game-xp))",
          gold: "hsl(var(--game-gold))",
          wood: "hsl(var(--game-wood))",
          stone: "hsl(var(--game-stone))",
          slot: "hsl(var(--game-slot-bg))",
          "slot-border": "hsl(var(--game-slot-border))",
          "slot-hover": "hsl(var(--game-slot-hover))",
          tooltip: "hsl(var(--game-tooltip))",
        },
        sidebar: {
      ...
      animation: {
        ...
        "item-pickup": "item-pickup 0.5s ease-out forwards",
